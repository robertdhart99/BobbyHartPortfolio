...
export const aboutData = {
    ...
    paragraphTwo:
        "I am currently doing contract work for Gameday PR as a front-end developer. In this role, I lead the initiative to redesign two websites, <a href='https://www.fearcincinnati.com/'>Cincinnati Fear</a> and <a href='https://www.bettheben.com/'>Bet the Benjamin</a>. Utilizing Adobe XD mockups, I ensure higher performance in alignment with the company's key performance indicators (KPIs). I actively implement approved mockup changes, focusing on improving SEO for a higher click-through rate (CTR) and enhancing the viewer experience to increase retention rate and improve call-to-action (CTA).",
    paragraphThree: '',
    resume:
